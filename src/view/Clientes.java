...
public class Clientes extends javax.swing.JFrame {
    ...
    public Clientes() throws SQLException {
        ...
        initComponents();
        cb = new ClienteBean();
        cc = new ListarController();
        this.listarProdutoView();
...
// change the Foreground
    ...
    private void initComponents() {
        ...
        jPanel2.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 90, -1, -1));
        ...
        tbl_cliente.setForeground(new java.awt.Color(51, 153, 255));
        tbl_cliente.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Código", "Nome", "CPF", "Data de nascimento", "Telefone", "Celular"
            }
        ) {
...
// TODO add your handling code here:
    ...
    private void tbl_clienteMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbl_clienteMouseClicked
        ...
        if (evt.getClickCount() == 2) {
            ...
            ClienteDetalhes frm = new ClienteDetalhes();
            frm.receberDados(tbl_cliente.getValueAt(tbl_cliente.getSelectedRow(), 0).toString(),
                ...
                tbl_cliente.getValueAt(tbl_cliente.getSelectedRow(), 5).toString());
            frm.setVisible(true);
        }
    ...
    public void listarProdutoView() throws SQLException {

        this.rs = cc.listarClienteController();
        ...
        while (this.rs.next()) {
            ...
            dtm.addRow(new String[]{
                ...
                String.valueOf(rs.getInt("telefone")),
