...
// change the Foreground
    ...
    private void initComponents() {
        ...
        tbl_pets.setFont(new java.awt.Font("Lucida Console", 0, 12)); // NOI18N
        tbl_pets.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Código", "Nome", "Raça", "Peso", "Dono", "IDCliente"
            }
        ) {
        ...
        tbl_pets.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        tbl_pets.setFillsViewportHeight(true);
        tbl_pets.setGridColor(new java.awt.Color(0, 102, 255));
        tbl_pets.setSelectionForeground(new java.awt.Color(0, 0, 0));
...
// TODO add your handling code here:
    ...
    private void tbl_petsMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbl_petsMouseClicked
        ...
        if (evt.getClickCount() == 2) {
            ...
            AnimalDetalhes frm = new AnimalDetalhes();
            frm.receberDados(tbl_pets.getValueAt(tbl_pets.getSelectedRow(), 0).toString(),
                    tbl_pets.getValueAt(tbl_pets.getSelectedRow(), 1).toString(),
                    tbl_pets.getValueAt(tbl_pets.getSelectedRow(), 2).toString(),
                    tbl_pets.getValueAt(tbl_pets.getSelectedRow(), 3).toString());
            frm.setVisible(true);
        }
    ...
    public void listarPets() throws SQLException {
        ...
        this.rs = list.listarAnimais();

        DefaultTableModel dtm = (DefaultTableModel) tbl_pets.getModel();
        ...
        while (this.rs.next()) {
            ...
            dtm.addRow(new String[]{
                ...
                String.valueOf(rs.getString("raça")),
                String.valueOf(rs.getDouble("peso")),
                String.valueOf(rs.getString("Dono")),
                String.valueOf(rs.getString("IDCliente"))
            });
        }
